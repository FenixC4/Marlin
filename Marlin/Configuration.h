...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech_x_FenixC4, SKR-mini-E3-V3.0)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3.0
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80, 400, 95 }
